...
class Social extends BaseModel
{
     ...
     * @var string
     */
    public $namespace_formprocessor = 'Lasallecrm\Lasallecrmapi\Formprocessing\Socials';
    ...
    public $field_list = [
        ...
        [
            ...
            'related_pivot_table_name' => 'company_social',
            'nullable'               => true,
        ...
        [
            ...
            'related_fk_constraint'  => false,
            'related_pivot_table'    => true,
            'related_pivot_table_name' => 'people_social',
            'nullable'               => true,
            'info'                   => 'Optional. Usually belongs to a company or to a person.',
            'index_skip'             => false,
            'index_align'            => 'center',
