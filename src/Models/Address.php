...
class Address extends BaseModel
{
     ...
     * @var string
     */
    public $namespace_formprocessor = 'Lasallecrm\Lasallecrmapi\Formprocessing\Addresses';
    ...
    public $field_list = [
        ...
        [
            ...
            'related_pivot_table_name' => 'company_address',
            'nullable'              => true,
        ...
        [
            ...
            'related_fk_constraint' => false,
            'related_pivot_table'   => true,
            'related_pivot_table_name' => 'people_address',
            'nullable'              => true,
            'info'                  => 'Optional. Usually an address belongs to a company or to a person.',
            'index_skip'            => false,
            'index_align'           => 'center',
